...
import com.mashup.lemonsatang.MonndayApplication
...
class KakaoSdkAdapter : KakaoAdapter() {
    ...
    override fun getSessionConfig(): ISessionConfig {
        return object : ISessionConfig {
            // 로그인 시에 인증 타입을 지정합니다.
            override fun getAuthTypes(): Array<AuthType> { // Auth Type
    ...
    override fun getApplicationConfig(): IApplicationConfig {
        return IApplicationConfig { MonndayApplication.getMonndayApplicationContext() }
    }
}